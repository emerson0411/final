...
df_raw = pd.read_csv("dataset2.csv")  # Cargo el csv ya depurado en Excel, porque pesaba demasiado y no podía subirlo a github como para depurar con código por acá
# No obstante, puedo quitar columnas sobrantes que Excel añadió automáticamente
df = df_raw.loc[:, ~df_raw.columns.str.contains(r"^Unnamed")]  
# ahora convierto EDAD y ANO a valores numéricos para poder filtrar y graficar
...
# Diccionario con coordenadas aproximadas de los distritos más poblados de Piura
district_coords = {
